...
# Note:
# Output of all model is without activate!


# todo: <<Learning Crisp Edge Detector Using Logical Refinement Network>>
# note:　The code is not disclosed
# class xxx:
#     def __init__(self):
#         super(xxx, self).__init__()


# todo: discontinued dice
# note: The code is not disclosed
# class xxx:
#     def __init__(self):
#         super(xxx, self).__init__()
...
# CE-Net: Context Encoder Network for 2D MedicalImage Segmentation（TMI 2019）
...
class CE_Net(nn.Module):
    def __init__(self, in_ch=3, num_class=1, pretrained=True,
